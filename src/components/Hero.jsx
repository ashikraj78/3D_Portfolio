      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi I'm <span className="text-[#915eff]">Ashik</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 ${styles.subText}`}>
            I bring ideas to online life and tell stories through every line of
            code.
          </p>
        </div>
      </div>
